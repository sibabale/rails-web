#!/usr/bin/env bash
# Live registration-only E2E — headed browser, real stack, keeps video recording.
set -euo pipefail
...
echo "=== Live BYOD registration (headed) ==="
...
echo ""
echo "Opening headed browser — registration only ..."
npx playwright test e2e/byod-registration.live.spec.ts \
