...
import { TypescriptRailsAccountsTransferInfrastructure } from '@/components/organisms/TypescriptRailsAccountsTransferSample/TypescriptRailsAccountsTransferSample';
