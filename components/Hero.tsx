...
const Hero: React.FC<HeroProps> = ({ onStart, isLoading = false }) => {
  ...
  useEffect(() => {
    ...
    const runSequence = async () => {
      ...
      setTerminalLines(prev => [...prev, '<span class="text-zinc-700 dark:text-zinc-400 font-mono font-bold">✓ SDK ready.</span>']);
      ...
      await delay(1200);
      setTerminalLines(prev => [...prev, '<span class="text-zinc-700 dark:text-zinc-400 font-mono font-bold">✓ Node: prod_east_04 (Session: 0x9f2...)</span>']);
      ...
      const logPool = [
        '<span class="text-cyan-600 dark:text-cyan-900/80 font-bold font-mono">Account:create</span> <span class="text-zinc-500 dark:text-zinc-600 font-mono">acc_****7721 owner:"H**** L***"</span>',
        '<span class="text-fuchsia-600 dark:text-fuchsia-900/80 font-bold font-mono">Payment:init</span> <span class="text-zinc-500 dark:text-zinc-600 font-mono">tx_****9912 amount:8,250.00 (WIRE)</span>',
        '<span class="text-amber-600 dark:text-amber-900/80 font-bold font-mono">Ledger:commit</span> <span class="text-zinc-500 dark:text-zinc-600 font-mono">block:922,111 entries:4 integrity:OK</span>',
        '<span class="text-emerald-600 dark:text-emerald-900/80 font-bold font-mono">Identity:pass</span> <span class="text-zinc-500 dark:text-zinc-600 font-mono">org_****911 jurisdiction:"US-DE"</span>',
